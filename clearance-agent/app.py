...
def _template_csv() -> bytes:
    ...
    samples = [
        ...
        ["2025-09-08", "S001", "良乡时光汇店",  "SKU001", "伊利雪糕70g",   7.50, 13.41, 14],
        ["2025-09-08", "S002", "丰台新广场店",  "SKU001", "伊利雪糕70g",   7.50, 13.41, 11],
        ["2025-09-01", "S001", "良乡时光汇店",  "SKU002", "芒果雪葩80g",   5.20,  9.90, 20],
        ["2025-09-01", "S002", "丰台新广场店",  "SKU002", "芒果雪葩80g",   5.20,  9.90, 17],
    ]
    buf = io.StringIO()
    w = csv.writer(buf)
    w.writerow(header)
